              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Evnt Location">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Event Email</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Event Email">
                  </div>
